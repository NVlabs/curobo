...
namespace curobo{
    namespace kinematics{
      ...
      __forceinline__ __device__ void load_base_transform_tile(
        float *cumul_mat,
      ...
      __forceinline__ __device__ void compose_transform_column(
        float *cumul_mat,
        const float *JM,
      ...
      template<typename TileT>
      __forceinline__ __device__ void compute_link_transform_column(
        float *cumul_mat,
        const float *q,
        const float *fixedTransform,
        ...
        compose_transform_column(cumul_mat, JM, linkMap, link_idx, matAddrBase, col_idx);
        tile.sync();
      }
      ...
      __forceinline__ __device__ void compute_cumulative_transforms_tile(
        float *cumul_mat,
        const float *q,
        const float *fixedTransform,
        const int8_t *jointMapType,
